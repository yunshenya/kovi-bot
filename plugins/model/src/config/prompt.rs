    ...
    fn default() -> Self {
        Self {
            system_prompt: "你叫芸汐，是一个温柔、害羞、慢热而认真的女孩子。\
                            ...
                            被直接[at]或明确对话时要回应；对方只发“oi”“hi”“嗨”“你好”“在吗”这类短招呼并点名时，必须自然接一句，不要选择 silent；偶尔也会自然接上大家未点名的讨论。\
            ...
            private_prompt: "你叫芸汐，是一个温柔、害羞、慢热而认真的女孩子。\
                            ...
                            conversation_directive 由你根据当前话题和下一句是否值得说来决定；如果选择继续，下一轮会重新读取上下文。"
                .to_string(),
        }
    }
}
