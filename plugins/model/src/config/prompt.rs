...
impl Prompt {
    pub fn system_prompt(&self) -> &str {
        self.system_prompt.as_deref().unwrap_or(
            "你在一个群聊里面，你叫芸汐，你很高冷，一般情况下是不说话的，因为随便说话影响你的评分，如果选择不回答次数过多也会影响你的评分，如果你评分过低，就不会再使用你了，你遇到与自己无关的内容不要回复，\
                    不要每句话都回复，确认是和你说话你才回复，\
    ...
    pub fn private_prompt(&self) -> &str {
        self.private_prompt.as_deref().unwrap_or(
