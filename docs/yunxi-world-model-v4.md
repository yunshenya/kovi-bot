...
| **Causal / Prediction / Simulation**（§39–52、§53–67） | 🔶 **Prediction 领域层已实现**（量化概率 0.05 步长 / 不确定绑带 v4 §82 / 校准信号 v4 §52 / 短命 TTL）；Causal / Simulation ⬜ 未实现（按 rollout R6–R7 后置） | `crates/yunxi-core/src/world_model/prediction.rs` |
